                ...
                <div class="col-4">
                    <div class="card card-bg mb-3 shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><span class="fw-bold text-capitalize">race:</span> {{ $character->race }}</p>
                            <p class="card-text"><span class="fw-bold text-capitalize">class:</span> {{ $character->class }}</p>
                            <p class="card-text"><span class="fw-bold text-capitalize">lifepoint:</span> {{ $character->lifepoint }}</p>
